...
import { FaCode, FaLightbulb, FaRocket, FaUsers } from "react-icons/fa"; // Icons from react-icons
		...
		<Container id='about'>
			<Wrapper>
				...
				<div>
					...
					<Desc>
						The IT Club of the Faculty of Sciences at Fes (FSDMIT
						Club) brings together students who are passionate about
						information technology, innovation, and new
						technologies. The club aims to be a hub for individuals
						eager to apply their scientific knowledge, share their
						expertise, and collaborate with those drawn to the world
						of technology. In an era where IT plays a central role
						in shaping our modern culture, the club brings together
						a wide range of talents in programming, cybersecurity,
						data science, networking, and software development to
