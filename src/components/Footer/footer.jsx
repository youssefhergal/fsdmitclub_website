...
function ContactAndFooter() {
	...
	return (
		<div
			...
			<CombinedContainer>
				<MainSection>
					<FooterSection>
						...
						<FooterLeft>
							<Description>
								Welcome to FSDM IT Club, the place where
								innovation meets learning and community spirit
								grows.
							</Description>
						</FooterLeft>
					</FooterSection>
			...
			<Copyright>
				&copy; 2023 - {currentYear} All rights reserved | This website
				is made with &#128153; by{" "}
				<CopyrightLink href='https://fsdmitclub.com' target='_blank'>
					Fsdmitclub.com
				</CopyrightLink>{" "}
			</Copyright>
		</div>
